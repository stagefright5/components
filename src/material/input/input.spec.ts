import {getSupportedInputTypes, _supportsShadowDom} from '@stagefright5/cdk/platform';
import {
  createFakeEvent,
  dispatchFakeEvent,
  wrappedErrorMessage,
...
@Component({standalone: false, template: `<mat-form-field><input matInput [type]="t"></mat-form-field>`})
