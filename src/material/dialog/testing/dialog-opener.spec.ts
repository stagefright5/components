...
import {MatTestDialogOpenerModule, MatTestDialogOpener} from '@stagefright5/material/dialog/testing';
import {MAT_DIALOG_DATA, MatDialogRef, MatDialogState} from '@stagefright5/material/dialog';
