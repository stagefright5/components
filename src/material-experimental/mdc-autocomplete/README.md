...
`@stagefright5/material-experimental/mdc-autocomplete` exports symbols with the same name and public
interface as all of the symbols found under `@stagefright5/material/autocomplete`
...
grep -lr --include="*.ts" --exclude-dir="node_modules" \
  --exclude="*.d.ts" "['\"]@stagefright5/material/autocomplete['\"]" | xargs sed -i \
