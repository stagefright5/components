...
3. Import the experimental `MatProgressSpinnerModule` and add it to the module that declares your
   ...
   ```ts
   import {MatProgressSpinnerModule} from '@stagefright5/material-experimental/mdc-progress-spinner';
...
grep -lr --include="*.ts" --exclude-dir="node_modules" \
  --exclude="*.d.ts" "['\"]@stagefright5/material/progress-spinner['\"]" | xargs sed -i \
